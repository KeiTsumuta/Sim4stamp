...
public class SimService extends ResourceFileIO implements java.io.Serializable {
    ...
    public void readProjectFile(String id) {
        ...
        String pf = paramMap.get("project.home." + id) + "/"
                + paramMap.get("project.pjparams." + id);
    ...
    public void saveProjectParams(File jfile) {
        try (FileOutputStream fo = new FileOutputStream(jfile);
                BufferedOutputStream out = new BufferedOutputStream(fo);) {
    ...
    public String getCurrentProjectHome() {
        //System.out.println("@@@@ " + "project.home." + getCurrentProjectId() + " : " + paramMap.get("project.home." + getCurrentProjectId()));
