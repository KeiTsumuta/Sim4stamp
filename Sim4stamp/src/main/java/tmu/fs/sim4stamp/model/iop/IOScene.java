...
public class IOScene implements JSONConvert {
	...
	private static double pentaProvidingMoreParam = 1.35;
	private static double providingLessParam = 0.5;
	private static double pentaProvidingLessParam = 0.7;
	...
	private double getDeviationLogicalValue(IOValue ioNf, int index) {
		...
		switch (deviation) {
			case NOT_PROVIDING:
				...
				break;
			case PROVIDING_MORE:
				val = val * getPentaProvidingMoreParam();
				break;
			case PROVIDING_LESS:
				val = val * getPentaProvidingLessParam();
				break;
			case TOO_EARLY:
				break;
			case TOO_LATE:
		...
		return getPentaNormal(val);
	}

	private double getPentaNormal(double value) {
		if (value == 0.0) {
			return 0.0;
		}
		if (value < 1.5) {
	...
	/**
	 * @return the pentaProvidingMoreParam
	 */
	public static double getPentaProvidingMoreParam() {
		return pentaProvidingMoreParam;
	}

	/**
	 * @param aPentaProvidingMoreParam the pentaProvidingMoreParam to set
	 */
	public static void setPentaProvidingMoreParam(double aPentaProvidingMoreParam) {
		pentaProvidingMoreParam = aPentaProvidingMoreParam;
	}
	...
	/**
	 * @return the pentaProvidingLessParam
	 */
	public static double getPentaProvidingLessParam() {
		return pentaProvidingLessParam;
	}

	/**
	 * @param aPentaprovidingLessParam the pentaProvidingLessParam to set
	 */
	public static void setPentaProvidingLessParam(double aPentaprovidingLessParam) {
		pentaProvidingLessParam = aPentaprovidingLessParam;
	}
